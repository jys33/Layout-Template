 ...
 * /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/ Según la especificación HTML5
 * q = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/
 */
(function(r,t,l){var u={required:"El campo %s es requerido.",matches:"El campo %s no coincide con el campo %s.","default":"El campo %s todavía está configurado como predeterminado, cámbielo.",valid_email:"El campo %s debe contener una dirección de correo electrónico válida.",valid_emails:"El campo %s debe contener todas las direcciones de correo electrónico válidas.",min_length:"El campo %s debe tener al menos %s caracteres de longitud.",max_length:"El campo %s no debe superar los %s caracteres de longitud.",exact_length:"El campo %s debe tener exactamente %s caracteres de longitud.",
greater_than:"El campo %s debe contener un número mayor que %s.",less_than:"El campo %s debe contener un número menor que %s.",alpha:"El campo %s solo debe contener caracteres alfabéticos.",alpha_numeric:"El campo %s solo debe contener caracteres alfanuméricos.",alpha_dash:"El campo %s solo debe contener caracteres alfanuméricos, guiones bajos y guiones.",numeric:"El campo %s debe contener solo números.",integer:"El campo %s debe contener un número entero.",decimal:"El campo %s debe contener un número decimal.",
is_natural:"El campo %s debe contener solo números positivos.",is_natural_no_zero:"El campo %s debe contener un número mayor que cero.",valid_ip:"El campo %s debe contener una IP válida.",valid_base64:"El campo %s debe contener una cadena base64.",valid_credit_card:"El campo %s debe contener un número de tarjeta de crédito válida.",is_file_type:"El campo %s debe contener solo archivos %s.",valid_url:"El campo %s debe contener una URL válida.",greater_than_date:"El campo %s debe contener una fecha más reciente que %s.",less_than_date:"El campo %s debe contener una fecha anterior a %s.",
greater_than_or_equal_date:"El campo %s debe contener una fecha que sea al menos tan reciente como %s.",less_than_or_equal_date:"El campo %s debe contener una fecha que sea %s o más antigua."},v=function(a){},w=/^(.+?)\[(.+)\]$/,g=/^[0-9]+$/,x=/^\-?[0-9]+$/,m=/^\-?[0-9]*\.?[0-9]+$/,q=/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i,y=/^[a-záéíóúÁÉÍÓÚÑñÜü ]+$/i,z=/^[a-z0-9]+$/i,A=/^[a-z0-9_\-]+$/i,B=/^[0-9]+$/i,C=/^[1-9][0-9]*$/i,D=/^((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})$/i,
